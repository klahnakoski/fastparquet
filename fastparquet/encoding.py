...
def _assemble_objects(schema_path, assign, defi, rep, val, dic, d, null, null_val, max_defi, prev_i):
    ...
    rep_type = [s.element.repetition_type for s in schema_path[1:]]
    result = assemble(rep_type, val, rep, defi, max_defi)
